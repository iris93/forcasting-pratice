...
# download mnist data if data dosen't exist 
...
def main(argv=None):  # pylint: disable=unused-argument
  if FLAGS.self_test:
    ...
    # Extract it into numpy arrays. so if you don't want to use mnist data,you can use your own data here. 

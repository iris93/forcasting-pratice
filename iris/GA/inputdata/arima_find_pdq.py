...
dta = dta[d:]    #need to change dta form to fit the following steps.
'''
#===========================================================  choose  p,q
'''
...
arma_mod40 = sm.tsa.ARMA(dta,(1,0)).fit()
arma_mod50 = sm.tsa.ARMA(dta,(3,0)).fit()
print(arma_mod20.aic,arma_mod20.bic,arma_mod20.hqic)
print(arma_mod30.aic,arma_mod30.bic,arma_mod30.hqic)
print(arma_mod40.aic,arma_mod40.bic,arma_mod40.hqic)
print(arma_mod50.aic,arma_mod50.bic,arma_mod50.hqic)
# aic_min,bic_min,hqic_min = arma_mod20.aic,arma_mod20.bic,arma_mod20.hqic
# for j in xrange(1,20):
# 	mod = []
# 	mod = sm.tsa.ARMA(dta,(i,0)).fit()
# 	if aic_min>mod.aic and bic_min>mod.bic and hqic_min>mod.hqic:
# 		aic_min,bic_min,hqic_min = mod.aic,mod.bic,mod.hqic
# 		p = i
# 		q = j
print ("p,q", p,q)

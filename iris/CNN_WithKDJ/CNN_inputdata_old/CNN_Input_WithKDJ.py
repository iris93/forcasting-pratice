...
for i in range(0,len(X_test)-8):
	for j in range(0,8):
		X_teset.append(X_test[i+j])
	# print X_teset
	# print "i:",i
	teX.append(X_teset)
	X_teset =[]
	open1, high1, low1, close1, volume1, K1, D1, J1 = X_test[i+7]
	open2, high2, low2, close2, volume2, K2, D2, J2 = X_test[i+8]
